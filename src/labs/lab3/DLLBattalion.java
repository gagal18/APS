...
public class DLLBattalion {
    ...
    public static void battalion(DLL<Integer> list, int a, int b) {
        ...
        DLLNode<Integer> beforeStart = start.pred;
        DLLNode<Integer> afterEnd = end.succ;
        ...
        end.pred = beforeStart;
        start.succ = afterEnd;

        if(afterEnd != null) afterEnd.pred = start;
        if(beforeStart != null) beforeStart.succ = end;
